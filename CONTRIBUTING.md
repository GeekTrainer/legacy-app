...
[fork]: https://github.com/GeekTrainer/legacy-app/fork
[pr]: https://github.com/GeekTrainer/legacy-app/compare
...
1. Fork and clone the repository:
   ```bash
   git clone https://github.com/YOUR-USERNAME/legacy-app.git
   cd legacy-app
   ```
...
Found a bug or have a feature request? Please [open an issue](https://github.com/GeekTrainer/legacy-app/issues/new/choose) with:
